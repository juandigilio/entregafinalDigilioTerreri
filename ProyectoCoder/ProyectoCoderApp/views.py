...
from .models import Avatar, Curso, Estudiante, Auto
...
def autos(request):
    ...
    return render(request,"ProyectoCoderApp/autos.html",{"autos":autos})

class ProfesList(LoginRequiredMixin,ListView):

    model = Auto
    template_name = "ProyectoCoderApp/autos_list.html"

class ProfeDetail(DetailView):

    model = Auto
    template_name = "ProyectoCoderApp/auto_detail.html"

class ProfeCreate(CreateView):

    model = Auto
    success_url = "/coderapp/autos/"#reverse_lazy("profes_list")
