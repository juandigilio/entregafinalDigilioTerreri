...
urlpatterns = [
    ...
    path('autos/list', ProfesList.as_view(), name="profe_list"),
    path('autos/<pk>', ProfeDetail.as_view(), name="profe_detail"),
    path('auto/nuevo', ProfeCreate.as_view(), name="profe_create"),
    path('autos/editar/<pk>', ProfeUpdate.as_view(), name="profe_update"),
    path('autos/eliminar/<pk>', ProfeDelete.as_view(), name="profe_delete"),
